...
function AboutContent() {
  ...
  const timeline = t.raw("history.timeline") as Array<{
    date?: string;
    year?: string;
    title?: string;
    description: string;
  ...
  const valuesCards = t.raw("missionVision.valuesCards") as Array<{
    icon: string;
    title: string;
    description: string;
  }>;
            ...
            <div className="relative">
              <div className="relative aspect-[3/4] max-w-[380px] rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt={t("founderMessage.signature")}
                  fill
              ...
              <div className="absolute -bottom-4 -right-4 lg:right-8 bg-[#D32F2F] text-white rounded-2xl px-5 py-3 shadow-lg">
                <p className="font-bold text-sm">{t("founderMessage.signature")}</p>
                <p className="text-white/70 text-xs">{t("founderMessage.signatureTitle")}</p>
              </div>
            </div>
        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-10">
          ...
          <div className="relative">
            ...
            <div className="space-y-10">
              {timeline.map((item, i) => {
                const yearValue = item.year ?? item.date ?? "";
                return (
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-white/10 backdrop-blur-sm
            ...
            <div className="text-left">
              ...
              <p className="text-white/70 text-sm">
                14 février 2025 — Ministère de l&apos;Éducation de Base
              </p>
            </div>
          </div>
        </div>
